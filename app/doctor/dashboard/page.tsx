...
import { DoctorDashboard, agentDashboard } from "@/lib/constants";
import Header from "@/app/Components/Header";

export default function Dashboard() {
  const [todaysAppointments, setTodaysAppointments] = useState<number | null>(null);
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setTodaysAppointments(data.data.todays_appointments);
